...
Other difficulty factor was the interaction of the React Three Fiber library with other libraries (like `react-wordcloud`), which caused performance problems, all solved in different ways, after extensive tweaking
and debugging with the Leva component.
